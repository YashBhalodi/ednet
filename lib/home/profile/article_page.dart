        ...
        children: <Widget>[
          Expanded(
            child: ListView(
              ...
              children: <Widget>[
                Text(article.title,style: Constant.articleTitleStyle,),
                SizedBox(height: 18.0),
                Text(article.subtitle,style: Constant.articleSubtitleStyle,),
                SizedBox(height: 24.0,),
                Text(article.content,style: Constant.articleContentStyle,),
                SizedBox(height: 18.0,),
                Row(
                  mainAxisSize: MainAxisSize.max,
